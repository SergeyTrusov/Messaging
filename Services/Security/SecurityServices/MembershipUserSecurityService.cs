...
namespace Services.Security.SecurityServices
{
    ...
    public class MembershipUserSecurityService : BaseSecirityService<MembershipUser, DefaultSecurityActions, string>
    {
        ...
        public MembershipUserSecurityService(IPrincipal principal)
        {
        ...
        /// </summary>
        public override void Check(MembershipUser securityObject, DefaultSecurityActions action, string id)
        {
